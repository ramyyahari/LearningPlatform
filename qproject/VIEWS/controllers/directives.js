/*********************************************************\
    Author: Erick Meyer
    Description: Contains the all of our custom directives
            to be used in our HVU online application.
\*********************************************************/

// The idea behind our page preview application is be able to
// show our page that the instructor has built in real time.
// Because we have injected the panel Service there is no reason
// To have anything passed to the directive.
