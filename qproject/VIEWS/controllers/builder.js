/*************************************************************************\
    Author: Erick Meyer
    Description: The 'builderController' is for use on the builder.html
    page. To ensure that the scope of this page has been saved, we use
    the 'panelService'. This way all of our modules can communicate between
    eachother and provide the desired functionality.
\*************************************************************************/
